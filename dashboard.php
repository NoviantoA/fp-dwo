...
<head>
    ...
    <title>ADVENTURE WORK - Dashboard</title>
...
<body>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            ...
                                            $sql = "SELECT SUM(OrderQty) as produk_terjual from fact_sales";
                                            $query = mysqli_query($mysqli, $sql);
                                            while ($row2 = mysqli_fetch_array($query)) {
                                                echo number_format($row2['produk_terjual'], 0, ".", ",");
                                            }
                                            ?>
                                        </div>
                                    </div>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            ...
                                            $sql = "SELECT COUNT(PurchaseOrderID) as jumlah_pending from fact_purchase where Status=1";
                                            $query = mysqli_query($mysqli, $sql);
                                            while ($row2 = mysqli_fetch_array($query)) {
    ...
    $a = 1;
    $query_customer = mysqli_query($conn, "SELECT SUM(f.TaxAmt) as customer FROM fact_purchase f JOIN time t ON f.PurchaseOrderID=t.time_id GROUP BY t.bulan ORDER BY t.tanggallengkap");
